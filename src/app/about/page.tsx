...
const AboutMe = () => {
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-100 rounded-lg shadow-md">
      <h1 className="text-3xl text-center font-semibold text-gray-900 mb-6">About Chioma Ezenwafor</h1>
      
      <div className="flex flex-wrap justify-center mb-6">
        <img src="https://res.cloudinary.com/dt3czltxx/image/upload/v1710130004/_S4A9111_llp05b.jpg" alt="Chioma Ezenwafor" className="rounded-full w-32 h-32 m-2" />
        <img src="https://res.cloudinary.com/dt3czltxx/image/upload/v1710130362/_S4A9013._vlxbsf.jpg" alt="Chioma Ezenwafor at work" className="rounded-full w-32 h-32 m-2" />
        <img src="https://res.cloudinary.com/dt3czltxx/image/upload/v1710130365/_S4A9174_jdekpq.jpg" alt="Chioma Ezenwafor speaking" className="rounded-full w-32 h-32 m-2" />
      </div>
