  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gray-100 rounded-lg shadow-md">
      ...
      <section className="mb-5 p-4 bg-white rounded shadow-sm">
        ...
        <p className="text-gray-600">
          If you have any questions about this Privacy Policy or our treatment of your personal data, please <a href="/contact" className="text-red-600 hover:text-red-800">contact me</a>.
        </p>
      </section>
    </div>
  );
