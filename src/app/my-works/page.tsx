...
const Myworks = () => {
  return (
    <div className="p-4 px-10">
      ...
      <div>
      <h2 className="text-2xl font-bold pt-4 hover:text-red-500">Portfolio</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 overflow-x-auto md:overflow-visible">
        <div className="card card-compact w-full md:w-96 bg-base-100 shadow-xl hover:shadow-sm">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <Link href="/school">
              <button className="btn text-white bg-red-500">View all</button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="card card-compact w-full md:w-96 bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
            <Link href="/school">
              <button className="btn text-white bg-red-500">All Episodes</button>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="card card-compact w-full md:w-96 bg-base-100 shadow-xl">
          ...
          <div className="card-body">
            <h2 className="card-title text-red-600">Follow The Money Show</h2>
